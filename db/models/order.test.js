...
describe('Order', () => {
  ...
  describe('Make sure Order model works', () => {
    it('all properties are there when all values are input', () =>
      Order.findOne({where: {zip: '11211'}})
        // .then(myOrder => expect(Object.keys(myOrder)).to.equal(['products','subtotal','tax','address','city','state','zip','shippingMethod','completedPurchase','purchaseDate']))
    ...
    it('all properties are there when only some values are input', () =>
