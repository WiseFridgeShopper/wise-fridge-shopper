...
module.exports = require('express').Router()
  .get('/', (req, res, next) => {
    ...
    req.queryIdString === 'user'
      ? getAllReviewsPromise = Review.findAll({where: {user_id: req.queryId}, include: [User]})
        : getAllReviewsPromise = Review.findAll({where: {magnet_id: req.queryId}, include: [User]})
